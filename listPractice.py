...
daily_transactions_split =[data.split(':') for data in daily_transactions]
transactions_clean = []
for transaction in daily_transactions_split:
  transactions_clean.append([data.strip(' ').strip('\n').strip(' ') for data in transaction])
...
for color in colors:
  if color == 'purple':
    print('{color}: {count}'.format(color=color, count=color_count(color)))
  else:
    print('{color}: {count} '.format(color=color, count=color_count(color)))
